...
#At the moment the node is performing 2 bends only - this may be easily modified.
#
##############################################################################
...
def zigzag():
    ...
    while (not rospy.is_shutdown()):
        ...
        prop_demand = 1100                      #This may need changing: it is the rpm value that yields the desired model speed
