...
def main():
    ...
    print "I'm coming home! Coming home,"        #please remove before submission
    print "Tell the world I'm coming home!"
...
################################################################################
        ...
        smach.StateMachine.add('HOME', GoToXY(lib, -2.5, -2.5, 1, 120),              #(lib, X, Y, Radial tolerance,timeout)
            transitions={'succeeded':'STOP', 'aborted':'STOP','preempted':'STOP'})   #The value for home has been selected so as to try not to smash the model
