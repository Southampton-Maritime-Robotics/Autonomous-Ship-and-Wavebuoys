...
################################################################################
        ...
        smach.StateMachine.add('WAYPOINT1', GoToXY(lib, -10, -20, 1, 120),  #(lib, X, Y, Radial tolerance,timeout)
            transitions={'succeeded':'WAYPOINT2', 'aborted':'STOP','preempted':'STOP'})            
    
        smach.StateMachine.add('WAYPOINT2', GoToXY(lib, 50, -20, 1, 120),  #(lib, X, Y, Radial tolerance,timeout)
            transitions={'succeeded':'WAYPOINT3', 'aborted':'STOP','preempted':'STOP'})     
                               
        smach.StateMachine.add('WAYPOINT3', GoToXY(lib, -10, -20, 1, 120),  #(lib, X, Y, Radial tolerance,timeout)
            transitions={'succeeded':'WAYPOINT3', 'aborted':'STOP','preempted':'STOP'}) 
        
        smach.StateMachine.add('WAYPOINT4', GoToXY(lib, 50, -20, 1, 120),  #(lib, X, Y, Radial tolerance,timeout)
            transitions={'succeeded':'WAYPOINT3', 'aborted':'STOP','preempted':'STOP'}) 
        
        smach.StateMachine.add('WAYPOINT5', GoToXY(lib, 0, -10, 1, 120),  #(lib, X, Y, Radial tolerance,timeout)
