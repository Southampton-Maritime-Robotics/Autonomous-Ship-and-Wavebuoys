...
################################################################################
        ...
        smach.StateMachine.add('WAYPOINT1', GoToXY(lib, -10, 10, 1, 120),  #(lib, X, Y, Radial tolerance,timeout)
            transitions={'succeeded':'WAYPOINT2', 'aborted':'STOP','preempted':'STOP'})            
    
        smach.StateMachine.add('WAYPOINT2', GoToXY(lib, -10, 20, 1, 120),  #(lib, X, Y, Radial tolerance,timeout)
            transitions={'succeeded':'WAYPOINT3', 'aborted':'STOP','preempted':'STOP'})     #In the original, 'succeeded': 'STOP'
        
        smach.StateMachine.add('WAYPOINT3', GoToXY(lib, -20, 20, 1, 120),  #(lib, X, Y, Radial tolerance,timeout)
            transitions={'succeeded':'WAYPOINT4', 'aborted':'STOP','preempted':'STOP'})     #In the original, 'succeeded': 'STOP'
                               
        smach.StateMachine.add('WAYPOINT4', GoToXY(lib, -20, 10, 1, 120),  #(lib, X, Y, Radial tolerance,timeout)
            transitions={'succeeded':'WAYPOINT5', 'aborted':'STOP','preempted':'STOP'})     #In the original, 'succeeded': 'STOP'
                               
        smach.StateMachine.add('WAYPOINT5', GoToXY(lib, -10, 10, 1, 120),  #(lib, X, Y, Radial tolerance,timeout)
            transitions={'succeeded':'STOP', 'aborted':'STOP','preempted':'STOP'})     #In the original, 'succeeded': 'STOP'
